...
This plan implements GQL (Graph Query Language) support for Interstellar. The implementation follows a **spike-first approach** where Phase 1 delivers a minimal end-to-end working query before building out the full feature set.
