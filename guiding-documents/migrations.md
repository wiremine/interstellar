# Interstellar: Schema Versioning and Migrations
...
```
interstellar migrate status         # Show current version and pending migrations
interstellar migrate up             # Apply all pending migrations
interstellar migrate up --to=5      # Migrate to specific version
interstellar migrate down           # Rollback last migration
interstellar migrate down --to=3    # Rollback to specific version
interstellar migrate plan           # Show what migrations would run (dry run)
interstellar migrate history        # Show migration history
interstellar migrate create <name>  # Create new migration template
```

### 8.2 Example Output

```
$ interstellar migrate status
...
Run 'interstellar migrate up' to apply these migrations.

$ interstellar migrate up
...
Interstellar's migration system provides:
