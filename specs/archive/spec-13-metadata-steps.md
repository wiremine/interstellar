...
This specification defines the implementation of Gremlin metadata/transform steps for Interstellar that extract metadata from traversers and property objects. These steps provide access to property keys/values, stream position indices, and loop depth in repeat operations.
